...
var url2 = "http://www.mozilla.org/firefox/";
...
function e(str) {
    ...
    _li1ds.background = _li2ds.background = _li3ds.background = _li4ds.background = "transparent url('" + imgPath + "browser-list.gif') no-repeat scroll left top";
    _li1ds.cursor = _li2ds.cursor = _li3ds.cursor = _li4ds.cursor = "pointer";
    _li1d.onclick = function() {
        window.open(url1,'Chrome','resizable=yes,toolbar=yes,scrollbars=yes,status=yes');
    };
    _li2d.onclick = function() {
        window.open(url2,'Firefox','resizable=yes,toolbar=yes,scrollbars=yes,status=yes');
    };
    _li3d.onclick = function() {
        window.open(url3,'Safari','resizable=yes,toolbar=yes,scrollbars=yes,status=yes');
    };
    _li4d.onclick = function() {
        window.open(url4,'Opera','resizable=yes,toolbar=yes,scrollbars=yes,status=yes');
    };
