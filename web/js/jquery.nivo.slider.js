...
(function($) {
    var NivoSlider = function(element, options){
        ...
        // Get this slider
        var slider = $(element);
		slider.css({overflow:'visible', '-webkit-border-radius': settings.borderRadius + 'px', '-moz-border-radius': settings.borderRadius + 'px', 'border-radius': settings.borderRadius + 'px'});
        ...
        //Create caption
        slider.append($('<div class="nivo-caption"></div>').css({ 'padding-left': settings.borderRadius + 'px'}));
