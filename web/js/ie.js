...
var msg2 = "To get the best possible experience using our website, we recommend that you have to install";
var msg3 = "another Web Browser. A list of The Most Popular Web Browsers can be found below.";
var msg4 = "Just click on The Icons to get to the Download Page";
var br1 = "Google Chrome";
var br2 = "Mozilla Firefox";
var br3 = "Safari";
var br4 = "Opera";
var url1 = "https://www.google.com/chrome";
var url2 = "http://www.mozilla.org/en-US/products/download.html";
...
function e(str) {
    ...
    _li1ds.background = _li2ds.background = _li3ds.background = _li4ds.background = "transparent url('" + imgPath + "browser_bg.gif') no-repeat scroll left top";
    _li1ds.cursor = _li2ds.cursor = _li3ds.cursor = _li4ds.cursor = "pointer";
    _li1d.onclick = function() {
        window.open(url1,'Chrome','width=auto,height=auto,resizable=yes,toolbar=yes,scrollbars=yes,status=yes');
    };
    _li2d.onclick = function() {
        window.open(url2,'Firefox','width=auto,height=auto,resizable=yes,toolbar=yes,scrollbars=yes,status=yes');
    };
    _li3d.onclick = function() {
        window.open(url3,'Safari','width=auto,height=auto,resizable=yes,toolbar=yes,scrollbars=yes,status=yes');
    };
    _li4d.onclick = function() {
        window.open(url4,'Opera','width=auto,height=auto,resizable=yes,toolbar=yes,scrollbars=yes,status=yes');
    };
    ...
    _ico1ds.background = "transparent url('" + imgPath + "chrome.gif') no-repeat scroll left top";
    _ico2ds.background = "transparent url('" + imgPath + "firefox.gif') no-repeat scroll left top";
    _ico3ds.background = "transparent url('" + imgPath + "safari.gif') no-repeat scroll left top";
    _ico4ds.background = "transparent url('" + imgPath + "opera.gif') no-repeat scroll left top";
